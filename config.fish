...
#alias tobash="sudo chsh anshul -s /bin/bash && echo 'Now log out.'"
#alias tozsh="sudo chsh anshul -s /bin/zsh && echo 'Now log out.'"
#alias tofish="sudo chsh anshul -s /bin/fish && echo 'Now log out.'"
